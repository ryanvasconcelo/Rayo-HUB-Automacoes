...
const accountMappings = [
  ...
  { companyId: company.companyId, eventCode: '042', dealerAccountCode: '6.1.1.01.003', dealerLotAccountCode: null, dc: 'D', description: 'Prêmios por Desempenho', active: true },
  ...
  // Comissões / prêmios — erros RAYO.xlsx + variantes/subtipos mesma conta
  { companyId: company.companyId, eventCode: '054', dealerAccountCode: '6.1.1.01.005', dealerLotAccountCode: null, dc: 'D', description: 'Comissão acessórios', active: true },
  { companyId: company.companyId, eventCode: '055', dealerAccountCode: '6.1.1.01.005', dealerLotAccountCode: null, dc: 'D', description: 'Comissão s/ Serv e mão de obra', active: true },
  { companyId: company.companyId, eventCode: '056', dealerAccountCode: '6.1.1.01.005', dealerLotAccountCode: null, dc: 'D', description: 'Comissão s/ peças', active: true },
  { companyId: company.companyId, eventCode: '057', dealerAccountCode: '6.1.1.01.005', dealerLotAccountCode: null, dc: 'D', description: 'Comissão SDR', active: true },
  { companyId: company.companyId, eventCode: '058', dealerAccountCode: '6.1.1.01.003', dealerLotAccountCode: null, dc: 'D', description: 'Prêmio SDR', active: true },
  { companyId: company.companyId, eventCode: '059', dealerAccountCode: '6.1.1.01.003', dealerLotAccountCode: null, dc: 'D', description: 'Prêmio Campanha', active: true },
  { companyId: company.companyId, eventCode: '067', dealerAccountCode: '6.1.1.01.006', dealerLotAccountCode: null, dc: 'D', description: 'Crédito banco de horas (Dealer 6099 / Horas Extras)', active: true },
  { companyId: company.companyId, eventCode: '069', dealerAccountCode: '6.1.1.01.003', dealerLotAccountCode: null, dc: 'D', description: 'Prêmio Empenho', active: true },
  { companyId: company.companyId, eventCode: '071', dealerAccountCode: '6.1.1.01.003', dealerLotAccountCode: null, dc: 'D', description: 'Prêmio vendas digitais', active: true },
  { companyId: company.companyId, eventCode: '074', dealerAccountCode: '6.1.1.01.003', dealerLotAccountCode: null, dc: 'D', description: 'Prêmio Agregados', active: true },
  { companyId: company.companyId, eventCode: '076', dealerAccountCode: '6.1.1.01.003', dealerLotAccountCode: null, dc: 'D', description: 'Prêmio GMAC', active: true },
  { companyId: company.companyId, eventCode: '077', dealerAccountCode: '6.1.1.01.003', dealerLotAccountCode: null, dc: 'D', description: 'Prêmio Captação', active: true },
  ...
  { companyId: company.companyId, eventCode: '084', dealerAccountCode: '6.1.1.01.003', dealerLotAccountCode: null, dc: 'D', description: 'Prêmio Meta', active: true },
  { companyId: company.companyId, eventCode: '087', dealerAccountCode: '6.1.1.01.002', dealerLotAccountCode: null, dc: 'D', description: 'Reembolso Atrasos', active: true },
  { companyId: company.companyId, eventCode: '094', dealerAccountCode: '6.1.1.01.005', dealerLotAccountCode: null, dc: 'D', description: 'Comissão GMAC', active: true },
  { companyId: company.companyId, eventCode: '095', dealerAccountCode: '6.1.1.01.005', dealerLotAccountCode: null, dc: 'D', description: 'Comissão Outros', active: true },
  { companyId: company.companyId, eventCode: '096', dealerAccountCode: '6.1.1.01.003', dealerLotAccountCode: null, dc: 'D', description: 'Prêmio Outros', active: true },
  { companyId: company.companyId, eventCode: '097', dealerAccountCode: '6.1.1.01.003', dealerLotAccountCode: null, dc: 'D', description: 'Prêmio Meta Complementar', active: true },
  { companyId: company.companyId, eventCode: '098', dealerAccountCode: '6.1.1.01.005', dealerLotAccountCode: null, dc: 'D', description: 'Comissões Garantia', active: true },
  ...
  { companyId: company.companyId, eventCode: '106', dealerAccountCode: '6.1.1.01.003', dealerLotAccountCode: null, dc: 'D', description: 'Prêmio ISC', active: true },
  { companyId: company.companyId, eventCode: '107', dealerAccountCode: '6.1.1.01.005', dealerLotAccountCode: null, dc: 'D', description: 'Comissão GMAC Varejo', active: true },
  { companyId: company.companyId, eventCode: '108', dealerAccountCode: '6.1.1.01.003', dealerLotAccountCode: null, dc: 'D', description: 'Prêmio GMAC Varejo', active: true },
  { companyId: company.companyId, eventCode: '118', dealerAccountCode: '1.1.4.01.004', dealerLotAccountCode: null, dc: 'D', description: 'Empréstimo Pessoal', active: true },
  ...
  { companyId: company.companyId, eventCode: '617', dealerAccountCode: '6.1.1.01.005', dealerLotAccountCode: null, dc: 'D', description: 'Diferença de Comissão', active: true },
  ...
  { companyId: company.companyId, eventCode: '949', dealerAccountCode: '6.1.1.01.002', dealerLotAccountCode: null, dc: 'D', description: 'Diferença de Salário', active: true },
  ...
  { companyId: company.companyId, eventCode: '977', dealerAccountCode: '6.1.1.01.005', dealerLotAccountCode: null, dc: 'D', description: 'Comissão venda direta', active: true },
  { companyId: company.companyId, eventCode: '978', dealerAccountCode: '6.1.1.01.005', dealerLotAccountCode: null, dc: 'D', description: 'Comissão s/ pcs e mão de obra', active: true },
  ...
  { companyId: company.companyId, eventCode: '980', dealerAccountCode: '6.1.1.01.005', dealerLotAccountCode: null, dc: 'D', description: 'Comissão s/ vendas', active: true },
  ...
  { companyId: company.companyId, eventCode: '993', dealerAccountCode: '6.1.1.01.003', dealerLotAccountCode: null, dc: 'D', description: 'Prêmio Acessórios - CCT', active: true },
  { companyId: company.companyId, eventCode: '996', dealerAccountCode: '6.1.1.01.002', dealerLotAccountCode: null, dc: 'D', description: 'Dif. do Piso da Categoria', active: true },
  { companyId: company.companyId, eventCode: '997', dealerAccountCode: '6.1.1.01.003', dealerLotAccountCode: null, dc: 'D', description: 'Prêmio F&I', active: true },
  { companyId: company.companyId, eventCode: '998', dealerAccountCode: '6.1.1.01.003', dealerLotAccountCode: null, dc: 'D', description: 'Prêmio Meta CCT - Mês anterior', active: true },
  ...
  { companyId: company.companyId, eventCode: '093', dealerAccountCode: '6.1.1.04.001', dealerLotAccountCode: null, dc: 'C', description: 'Desconto Assist. Médica Amil', active: true },
  { companyId: company.companyId, eventCode: '101', dealerAccountCode: '6.1.1.04.006', dealerLotAccountCode: null, dc: 'C', description: 'Desconto de vale', active: true },
  { companyId: company.companyId, eventCode: '102', dealerAccountCode: '6.1.1.01.002', dealerLotAccountCode: null, dc: 'C', description: 'Desc. pagamentos indevidos (Dealer 6095)', active: true },
  ...
  { companyId: company.companyId, eventCode: '390', dealerAccountCode: '6.1.1.01.002', dealerLotAccountCode: null, dc: 'C', description: 'Líquido Negativo Compensação', active: true },
  ...
  { companyId: company.companyId, eventCode: '958', dealerAccountCode: '6.1.1.04.003', dealerLotAccountCode: null, dc: 'C', description: 'Desconto Refeição', active: true },
  ...
  { companyId: company.companyId, eventCode: '995', dealerAccountCode: '2.1.1.02.007', dealerLotAccountCode: null, dc: 'C', description: 'Consignado Crédito Trabalhador', active: true },
