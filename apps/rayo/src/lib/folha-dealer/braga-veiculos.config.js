...
const accountMappings = [
  ...
  // Comissões / prêmios — de-para contador (erros RAYO.xlsx / Planilha2, maio/2026)
  ...
  { companyId: company.companyId, eventCode: '067', dealerAccountCode: '6.1.1.01.002', dealerLotAccountCode: null, dc: 'D', description: 'Crédito banco de horas', active: true },
  ...
  { companyId: company.companyId, eventCode: '102', dealerAccountCode: '6.1.1.01.002', dealerLotAccountCode: null, dc: 'C', description: 'Desc. de pagamentos indevidos', active: true },
