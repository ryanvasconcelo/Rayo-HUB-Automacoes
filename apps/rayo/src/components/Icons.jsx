/**
 * SVG Icon system — replaces all emojis with clean minimal icons
...
export function IconBolt({ size = 20, className = '' }) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
            <path d="M13 2L4.09 12.63a1 1 0 0 0 .78 1.62H10l-1 7.75a.5.5 0 0 0 .86.41L19.91 11.37a1 1 0 0 0-.78-1.62H14l1-7.75a.5.5 0 0 0-.86-.41L13 2z" />
        </svg>
    );
}
...
export function IconExport({ size = 20, className = '' }) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
